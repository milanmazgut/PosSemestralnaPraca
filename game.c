...
void player_roll_dice(game *this, player* currentPlayer, const char* playerName, char* outputPlayer, char* outputOthers) {
    int dice_1;
    int dice_2;
    ...
    if ( dice_1 == dice_2) {
        ...
        snprintf(outputOthers, BUFFER_SIZE, "Player %s dropped %s and %s, and got %s", playerName, animalNames[dice_1], animalNames[dice_2], animalNames[dice_1]);
